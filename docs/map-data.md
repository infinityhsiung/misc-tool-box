...
| Century Avenue station | 河西走廊 | 31.2308126 | 121.5229813 | [Stop area](https://www.openstreetmap.org/relation/4029763) |
...
Century Avenue and Expo use the station and Expo Park as representative anchors. Both user-supplied Fudan names share one label to avoid overlapping markers; the spelling 桶关 is preserved.
